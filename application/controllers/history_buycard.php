<?php
class History_buycard extends MY_Controller{
	...
	public function index(){
		...
		$this->data['title'] = "Lịch mua thẻ";
		$this->data['title_main'] = "Lịch sử mua thẻ";
		...
		$this->parser->parse('default/layout/profile/balancer/history_buycard',$this->data);
