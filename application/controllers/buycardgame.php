<?php
class Buycardgame extends MY_Controller{
						...
						if(!empty($TelcoInfo->result)){
								...
								if(!empty($this->objects)){
									if(is_array($this->objects)){
										...
										$this->parser->parse('default/col/col-end',$this->data);
										$this->parser->parse('default/col/col-9-start',$this->data);
										$this->parser->parse('default/layout/share/thanh-toan-cart-game',$this->data);
	...
	public function confirm($msg){
		echo '<script> alert("'.$msg.'"); window.location.href = "'.base_url('mua-the-game.html').'";</script>';
	}
	public function code(){
		...
		$this->parser->parse('default/col/col-end',$this->data);
		$this->parser->parse('default/col/col-9-start',$this->data);
		$this->parser->parse('default/layout/share/mua_ngay_main_game',$this->data);
		$this->parser->parse('default/layout/buycardgame',$this->data);
		$this->parser->parse('default/col/col-end',$this->data);
		$this->parser->parse('default/col/end-main',$this->data);
		$this->parser->parse('default/footer',$this->data);
	}
