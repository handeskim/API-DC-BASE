		...
		<div class="col-md-12 col-sm-12 col-xs-12 sub container-table" id="container-table"> 
			<div class="col-md-12 col-sm-12 col-xs-12 sub " id="ResponseTableStatic" style="display:block;"> 
				<table  id="TableSLData"  class="table table-striped table-bordered table-condensed table-hover display "style="width:100%" role="grid" cellspacing="0">
					...
					<td><input type="text" class="text_filter" placeholder="[<?php echo 	lang('Telco'); ?>]"></td>
					<td><?php echo 	lang('CardQuantity'); ?></td>
					<td><?php echo 	lang('CardPrice'); ?></td>
					<td><input type="text" class="text_filter" placeholder="[<?php echo 	lang('Type'); ?>]"></td>
					<td><?php echo 	lang('PriceDiscount'); ?></td>
					<td><input type="text" class="text_filter" placeholder="[<?php echo 	lang('CardName'); ?>]"></td>
					<td><?php echo 	lang('MoneyTransfer'); ?></td>
					<td><?php echo 	lang('TotalOder'); ?></td>
					<td><input type="text" class="text_filter" placeholder="[<?php echo 	lang('client_id'); ?>]"></td>
					<td><input type="text" class="text_filter" placeholder="[<?php echo 	lang('email'); ?>]"</td>
					<td><input type="text" class="text_filter" placeholder="[<?php echo 	lang('full_name'); ?>]"></td>
						<th> </th>
						 <tr>
...
<script src="<?php echo base_url(); ?>app/Core/Reseller/CMS/cart_cms.js"> </script>
