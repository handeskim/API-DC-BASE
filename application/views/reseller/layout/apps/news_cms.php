...
<div class="col-md-12 col-sm-12 col-xs-12 sub reset">
	<div class="col-md-12 col-sm-12 col-xs-12 sub reset">
		<h3> {title_main} | <button class="btn btn-default add_new" type="button" onclick="add_news()"> Thêm mới </button></h3>
		<div class="col-md-12 col-sm-12 col-xs-12 sub reset">
			...
			<div class="col-md-12 col-sm-12 col-xs-12 sub " id="ResponseTableStatic" style="display:block;"> 
				<table  id="TableSLData"  class="table table-striped table-bordered table-condensed table-hover display "style="width:100%" role="grid" cellspacing="0">
					...
					<tfoot>
						...
						<td><input type="text" class="text_filter" placeholder="[<?php echo 	lang('title'); ?>]"></td>
						<td><input type="text" class="text_filter" placeholder="[<?php echo 	lang('description'); ?>]"></td>
...
<script src="<?php echo base_url(); ?>app/Core/Reseller/CMS/news_cms.js"> </script>
