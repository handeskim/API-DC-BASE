...
<?php if(!empty($withdrawal['transaction'])){
	...
	<div class="form-group  col-md-2 col-sm-6 col-xs-12 sub">
		<button type="button" onclick="Cancel_transaction('{root_id}')" class="btn btn-warning "> <i class="fa fa-ban"> </i> HỦY GIAO DỊCH  </button>	
	</div>
	<?php	} }  ?> 
	<?php if($withdrawal['transaction'] === 'done'){ ?> 
	<div class="form-group  col-md-2 col-sm-6 col-xs-12 sub">
