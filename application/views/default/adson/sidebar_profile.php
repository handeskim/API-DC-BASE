<div class="col-md-12 col-sm-12 col-xs-12 sub profile_bar">
	...
	<div id="profile_left" class="profile_left col-md-12 col-sm-12 col-xs-12 sub">
		<div class="profile_left col-md-12 col-sm-12 col-xs-12 sub cate catex"> <h5> <span> <i class="fa fa-user"> </i> </span><span class="cate_profile"> Tài khoản <i class="fa fa-plus-square pull-right ppx ppx_account"> </i></span> </h5></div>
		<div class="profile_left col-md-12 col-sm-12 col-xs-12 sub sub_profile_info sub_cate_profile">
			<div class="profile_left col-md-12 col-sm-12 col-xs-12 sub cate catex"> <h5> <span> <i class="fa fa-bank"> </i> </span><span class="cate_profile"> Chỉnh sửa thông tin</span> </h5></div>
			<div class="profile_left col-md-12 col-sm-12 col-xs-12 sub cate catex"> <h5> <span> <i class="fa fa-bank"> </i> </span><span class="cate_profile"> Tài khoản ngân hàng</span> </h5></div>
			<div class="profile_left col-md-12 col-sm-12 col-xs-12 sub cate catex"> <h5> <span> <i class="fa fa-unlock"> </i> </span><span class="cate_profile"> Đổi mật khẩu cấp 1</span> </h5></div>
			<div class="profile_left col-md-12 col-sm-12 col-xs-12 sub cate catex"> <h5> <span> <i class="fa fa-question-circle"> </i> </span><span class="cate_profile"> Quên mật khẩu cấp 1</span> </h5></div>
			<div class="profile_left col-md-12 col-sm-12 col-xs-12 sub cate catex"> <h5> <span> <i class="fa fa-unlock"> </i> </span><span class="cate_profile"> Thay mật khẩu cấp 2</span> </h5></div>
			<div class="profile_left col-md-12 col-sm-12 col-xs-12 sub cate catex"> <h5> <span> <i class="fa fa-question-circle"> </i> </span><span class="cate_profile"> Quên mật khẩu cấp 2</span> </h5></div>
		</div>
		...
		<div class="profile_left col-md-12 col-sm-12 col-xs-12 sub sub_profile_banlancer sub_cate_profile">
			...
			<div class="profile_left col-md-12 col-sm-12 col-xs-12 sub cate catex"> <h5> <span> <i class="fa fa-history"> </i> </span><span class="cate_profile"> Lịch sử thay đổi số dư</span> </h5></div>
			...
			<div class="profile_left col-md-12 col-sm-12 col-xs-12 sub cate catex"> <h5> <span> <i class="fa fa-exchange"> </i> </span><span class="cate_profile"> Chuyển khoản</span> </h5></div>
		...
		<div class="profile_left col-md-12 col-sm-12 col-xs-12 sub cate catex"> <h5> <span> <i class="fa fa-connectdevelop"> </i> </span><span class="cate_password"> Nhà Phát Triển </span> </h5> </div>
