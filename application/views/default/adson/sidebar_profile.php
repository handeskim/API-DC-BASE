<div class="col-md-12 col-sm-12 col-xs-12 sub profile_bar">
	...
	<div id="profile_left" class="profile_left col-md-12 col-sm-12 col-xs-12 sub">
		...
		<div class="profile_left col-md-12 col-sm-12 col-xs-12 sub sub_profile_cart sub_cate_profile">
			<div class="profile_left col-md-12 col-sm-12 col-xs-12 sub cate catex"> <h5> <a  href="<?php echo base_url('history_card.html');?>"> <span> <i class="fa fa-circle-o"> </i> </span><span class="cate_profile"> Tra cứu tình trạng đổi thẻ</span>  </a></h5></div>
		...
		<div class="profile_left col-md-12 col-sm-12 col-xs-12 sub sub_profile_banlancer sub_cate_profile">
			...
			<div class="profile_left col-md-12 col-sm-12 col-xs-12 sub cate catex"> <h5>  <a href="<?php echo base_url('history_naptien.html');?>"><span> <i class="fa fa-history"> </i> </span><span > Lịch sử nạp tiền</span> </a></h5></div>
