<div class="main-profile-body-edit col-md-12 col-sm-12 col-xs-12 sub">
	...
	<div class="main-profile-body col-md-12 col-sm-12 col-xs-12 sub ">
		<div class="main-profile-body-details col-md-12 col-sm-12 col-xs-12 sub main-body-col"> 
				...
				THAY ĐỔI MẬT KHẨU CẤP 2 (Mã bảo mật) </span>  </h3>
				<div class="col-md-12 col-sm-12 col-xs-12 sub tab_add_bank" >
					<form class="from-edit-profile col-md-12 col-sm-12 col-xs-12 sub " method="post" action="<?php echo base_url();?>profile/auth" >
						<div class="input-group">
							<span class="input-group-addon"><?php echo lang('password_old');?></span>
								<input type="password" name="password_old" class="form-control" placeholder="" value="" required>
						</div>
						<div class="input-group">
							<span class="input-group-addon"><?php echo lang('password_new');?></span>
								<input type="password" name="password_new" class="form-control" placeholder="" value="" required>
						</div>
						<div class="input-group">
							<span class="input-group-addon"><?php echo lang('password_duplicate');?></span>
								<input type="password" name="password_duplicate" class="form-control" placeholder="" value="" required>
						</div>
						...
						<div class="col-md-12 col-sm-12 col-xs-12 sub ">
							<div class="col-md-6 col-sm-6 col-xs-12">
								<button type="submit" class="btn btn-primary pull-left"> THAY ĐỔI </button>
							</div>
							<div class="col-md-6 col-sm-6 col-xs-12">
