<?php
class Blockseri extends MY_Controller{
	...
	public function index(){
		if($this->_role == 1 || $this->_role == 2 || $this->_role ==3){
			$this->data['title'] = 'Lịch sử khóa Seri Thẻ Đổi';
			$this->data['title_main'] = 'Lịch sử khóa Seri Thẻ Đổi';
			...
			$this->parser->parse('reseller/layout/apps/blockseri_cms',$this->data);
